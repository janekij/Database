                ...
                <table width="968" border="0">
                  <tbody>
                    <tr>
                      ...
                      <td width="718"><span class="text-center fw-bold text-uppercase"><center><h3>เวชระเบียนผู้ป่วย 2564 ศูนย์กักตัวบิ๊กเกอร์แลนด์ คลอง 9 </h3></center></span></td>
                    </tr>
                  </tbody>
                </table>
                <hr>
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="ubah.php?nis=<?= $row['nis']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;แก้ไขข้อมูล</a> |

                                    <a href="hapus.php?nis=<?= $row['nis']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('คุณต้องการลบข้อมูล <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;ลบ</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
