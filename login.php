...
body {
    background-image: url(img/bg/34.jpg);
    background-repeat: no-repeat;
}
    </style>
<title>Login |  | เวชระเบียนสนามคลอง 9</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">เวชระเบียน | สนามคลอง 9</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="list.php">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/memphis-colorful.jpg');">
                <h4 class="fw-bold">Login | Admin</h4>
                <!-- Ini Error jika tidak bisa login -->
                <?php if (isset($error)) : ?>
                    <?php echo '<script>alert("กรุณาใส่ข้อมูลให้ถูกต้อง!!!");</script>'; ?>
                <?php endif; ?>
